...
smiData.RigidTransform(2).angle = 2.2437382619900821;  % rad
smiData.RigidTransform(2).axis = [-0.6196505817503849 0.48173261574531129 -0.61965058175038434];
...
smiData.RigidTransform(4).angle = 1.5994446325495646;  % rad
smiData.RigidTransform(4).axis = [-0.16687340871885917 -0.97175435729668691 0.16687340871885939];
...
smiData.RigidTransform(6).angle = 1.7209796786595761;  % rad
smiData.RigidTransform(6).axis = [-0.36075880646333969 -0.86006172285382654 0.36075880646334119];
...
smiData.CylindricalJoint(1).Rz.Pos = 120.40547501146436;  % deg
smiData.CylindricalJoint(1).Pz.Pos = 0;  % in
smiData.CylindricalJoint(1).ID = '[Mecanum2-1:-:Part1-1]';
...
smiData.PrismaticJoint(1).ID = '[MirrorMecanum1-1:-:Part1-1]';

smiData.PrismaticJoint(2).Pz.Pos = 0;  % m
smiData.PrismaticJoint(2).ID = '[MirrorMecanum-1:-:Part1-1]';

smiData.PrismaticJoint(3).Pz.Pos = 0;  % m
smiData.PrismaticJoint(3).ID = '[Mecanum-1:-:Part1-1]';
